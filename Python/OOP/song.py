...
class Album:
    ...
    Attributes:
        ...
        artist: (Artist): The artist will default to an artist with the name "Various Artists".
...
class Artist:
    ...
    Attributes:
        name (str): The name of hte artist.
...
def find_object(field, object_list):
    """Check 'object_list' to see in an object with a 'name' attribute equal to 'field' exists, return it if so."""
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            # create a new song object adn add it to the current album's collection
