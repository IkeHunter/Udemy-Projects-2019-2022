...
"""
    ...
    When the class does not "own" the object, it is aggregation (still is 'has a...' relationship)
"""
if __name__ == '__main__':
    ...
    new_body.add_tag('p', "The composition object doesn't actually own the objects it's composed of"
                      " - if it's destroyed, those continue to exist.")
...
# # give our doc new content by switching it's body
